                ...
                <div class="w-full">
                    ...
                    <div class="grid grid-cols-1 gap-2 my-2 md:grid-cols-3 md:col-span-7">
                        @foreach ($product->gallery as $key => $image)
                            <img src="{{ $image }}" alt="image-{{ $key }}" class="object-cover rounded-md aspect-square" />
                        @endforeach
                    </div>
                </div>
            </div>
            <div class="md:col-span-3">
                <div class="flex flex-col gap-2">
                    <div>
                        ...
                        <h2 class="text-sm text-gray-800">{{ $product->sort_desc }}</h2>
                ...
                <div>
                    ...
                    <div class="my-2 prose text-gray-800 dark:text-neutral-200 text-justify">
